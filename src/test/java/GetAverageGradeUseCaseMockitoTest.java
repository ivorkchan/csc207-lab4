 ...
 *
 * <p>This demonstrates using the Mockito library for "mocking" the GradeDataBase.
 *
 * <p>This should pass if the "to do" Task 3a is correctly implemented.
 */
public class GetAverageGradeUseCaseMockitoTest {
    @Mock private GradeDataBase gradeDB;
    ...
    void setUp() {
        MockitoAnnotations.initMocks(
                this); // Use openMocks() instead of initMocks() if using Mockito 3.2+
